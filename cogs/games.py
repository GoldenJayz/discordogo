...
class games(commands.Cog):
    ...
    async def editimage(self, embed, first, target):
        ...
        AUTHOR_PFP = first.avatar_url_as(size=256)
    ...
    async def ball(self, ctx, *, args):
        ...
        randomgif = [
            'https://media3.giphy.com/media/141iprzbEPjCiQ/giphy.gif',
            'https://i.imgur.com/akdtE4H.gif',
    ...
    """
        fight command where 2 members can beat each other up
    """
